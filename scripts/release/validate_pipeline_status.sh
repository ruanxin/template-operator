...
REF_NAME="${1:-"main"}"
# TODO this needs to be reverted to main repository after testing!
STATUS_URL="https://api.github.com/repos/lindnerby/template-operator/commits/${REF_NAME}/status"
